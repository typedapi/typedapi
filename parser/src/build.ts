...
export const build = (config: BuildConfig): void => {
    ...
    p("import { ObjectReflection } from \"typedapi-core\"")
    buildInterface(apiDeclaration, b, config.sourceObjectName)
    p(`const reflection: ObjectReflection = ${JSON.stringify(filteredReflection, undefined, 4)}`)
    ...
    p("// Generated file. Do not modify it.")
    p("import { ObjectReflection } from \"typedapi-core\"")
    p(`export const reflection: ObjectReflection = ${JSON.stringify(reflection, undefined, 4)}\n`)
